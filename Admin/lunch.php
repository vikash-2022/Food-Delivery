...
$query=mysqli_query($con,"DELETE FROM lunch WHERE `lunch`.`Id` = '$delete_id'");
};
?>
  ...
  <div class="card card-b ">
               ...
               <div class="card-body">
                  ...
                  <div class="row r-card">
                     ...
                     <input type="text" name="t1" class="form-control" id="exampleFormControlInput1" placeholder="Product Name" style="border:1px solid;text-align: center;">
                     </div>
                     <div class="col-sm-6 ">
                     <label for="exampleFormControlInput1" class="form-label l-label">Product Price</label>
                     <input type="text" name="t2" class="form-control" id="exampleFormControlInput1" placeholder="Product Price" style="border:1px solid;text-align: center;">
                     </div>
                     <div class="col-sm-6 mt-2">
                     <label for="exampleFormControlInput1" class="form-label l-label">Product Category</label>
                     <input type="text" name="t3" class="form-control" id="exampleFormControlInput1" placeholder="veg/non-veg" style="border:1px solid;text-align: center;">
                     </div>
                     <div class="col-sm-6 mt-2">
                     <label for="exampleFormControlInput1"  class="mb-3">
                  <label class="fs-5">Select Dish Image</label><br>
                  <input type="file" name="t5" id="t5" placeholder="image" style="border:1px solid;text-align:center;">
               </div>
               ...
               if (isset($_POST['submit'])) {
                  ...
                  $data =  mysqli_query($con, "INSERT INTO `lunch`(`title`,`price`, `type`,  `img`) VALUES ('$t1','$t2','$t3','$filename')");
               }
               ?>
            ...
            <div class="col-lg-3 ">
               <div class="card text-center" style="width: 18rem; height: auto;margin-top:26px;">
                  ...
                  <div class="card-body">
                     ...
                     <a href="update.php?select=<?php echo $rowdoc['id']?>&tb_name=lunch" class="btn btn-primary">update</a>
                     <a href="lunch.php?select=<?php echo $rowdoc['id']?>" class="btn btn-danger">Delete</a>
                  </div>
               </div>
            </div>
         <?php } ?>
