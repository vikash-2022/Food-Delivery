...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
   <div class="container">
         ...
         <div class="card-body">
            <form method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
               <div class="row r-card">
                  <div class="col-sm-6">
                     <label for="validationCustom01" class="form-label l-label">Product Name</label>
                     <input type="text" name="t1" class="form-control" id="validationCustom01" placeholder="Product Name" style="border:1px solid;text-align: center;" required>
                  </div>
                  <div class="col-sm-6 ">
                     <label for="validationCustom02" class="form-label l-label">Product Price</label>
                     <input type="text" name="t2" class="form-control" id="validationCustom02" placeholder="Product Price" style="border:1px solid;text-align: center;" required>
                  </div>
                  ...
                  <div class="mt-3 b-add">
                     <button class="btn btn-warning b-w" type="submit" name="submit">Add</button>
                  </div>
               </div>
         </div>
         </form>
      ...
      if (isset($_POST['submit'])) {
         ...
         $data =  mysqli_query($con, "INSERT INTO `breakfast`(`title`,`price`, `type`,  `img`) VALUES ('$t1','$t2','$t3','$filename')");
      }
      ?>
               ...
               <div class="col-lg-3 ">
                  <div class="card text-center" style="width: 18rem; height:auto;margin-top:26px;">
                     ...
                     <div class="card-body">
                        ...
                        <a href="update.php?select=<?php echo $rowdoc['Id']?>&tb_name=breakfast" class="btn btn-primary">update</a>
                        <a href="breakfast.php?select=<?php echo $rowdoc['Id'] ?>" class="btn btn-danger">Delete</a>
                     </div>
                  </div>
