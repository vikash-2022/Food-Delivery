                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                                            ...
                                            <td data-th="Product">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 text-left mt-sm-2">  
                                                        <h4 style=" text-align: left; margin-top:26px;"><?php echo $item['name']; ?><form method="POST">
                                                            <input type="hidden" name="i_name" value="<?php echo $item['name']; ?>"></form>
                                                        </h4>
                        ...
                        <div class="float-right text-right">
                            ...
                            <h1>Rs <span id="gtotal"></span>
                                <input type="text" id="gtotal" name="All_total" value=" <?php
                                                                                        echo "<script>document.writeln(gt);</script>";
                                                                                        ?>">
                            </h1>
                        </div>
                    </div>
