            ...
            <div class="menu-tab-wp">
                            <div class="row">
                                ...
                                <a href="breakfast.php">
                                    <li class="filter active" data-filter=".breakfast" style="color: rgb(255, 255, 255);">
                    ...
                    <div class="col-lg-12 m-auto">
                        <div class="menu-tab text-center">
                            <ul class="filters">
                                ...
                                <a href="breakfast.php">
                                    <li class="filter " data-filter=".breakfast" style="color: rgb(255, 255, 255);">
                                        <img src="assets/images/menu-2.png" alt="">
                                        Breakfast
                                    </li>
                                </a>
                                <a href="lunch.php">
                                    <li class="filter active" data-filter=".lunch" style="color: rgb(13, 13, 37);">
                                        <img src="assets/images/menu-3.png" alt="">
                                        Lunch
                                    </li>
                                </a>
                                        ...
                                        <form action="" method="POST">
                                            ...
                                            <div class="dist-bottom-row">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <button class="dish-add-btn" name="add_to_cart">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="sec-title text-center mb-5">
                        ...
                        <div class="sec-title-shape mb-4">
                            <img src=1"assets/images/title-shape.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
